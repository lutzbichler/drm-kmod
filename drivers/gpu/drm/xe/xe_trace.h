...
static inline void
trace_xe_tlb_inval_fence_create(struct xe_device *xe, struct xe_tlb_inval_fence *fence)
{
}

static inline void
trace_xe_tlb_inval_fence_work_func(struct xe_device *xe, struct xe_tlb_inval_fence *fence)
{
}

static inline void
trace_xe_tlb_inval_fence_cb(struct xe_device *xe, struct xe_tlb_inval_fence *fence)
{
}
