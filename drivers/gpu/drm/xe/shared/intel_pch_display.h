...
#ifdef I915
bool intel_has_pch_trancoder(struct xe_device *xe,
...
void intel_pch_sanitize(struct xe_device *xe);
#else
static inline bool intel_has_pch_trancoder(struct xe_device *xe,
					   enum pipe pch_transcoder)
{
	return false;
}
...
static inline void intel_pch_sanitize(struct xe_device *xe)
{
}
#endif
