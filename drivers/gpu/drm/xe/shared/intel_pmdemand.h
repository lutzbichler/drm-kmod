...
void intel_pmdemand_init_pmdemand_params(struct xe_device *xe,
					 struct intel_pmdemand_state *pmdemand_state);
void intel_pmdemand_update_port_clock(struct xe_device *xe,
				      struct intel_pmdemand_state *pmdemand_state,
				      enum pipe pipe, int port_clock);
void intel_pmdemand_update_phys_mask(struct xe_device *xe,
