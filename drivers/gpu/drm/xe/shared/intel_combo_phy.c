...
static const struct icl_procmon *
icl_get_procmon_ref_values(struct xe_device *dev_priv, enum phy phy)
{
	u32 val;
...
static void icl_set_procmon_ref_values(struct xe_device *dev_priv,
				       enum phy phy)
{
...
static bool check_phy_reg(struct xe_device *dev_priv,
...
static bool icl_verify_procmon_ref_values(struct xe_device *dev_priv,
					  enum phy phy)
{
	const struct icl_procmon *procmon;
	bool ret;
...
static bool has_phy_misc(struct xe_device *xe, enum phy phy)
{
	/*
...
static bool icl_combo_phy_enabled(struct xe_device *dev_priv,
				  enum phy phy)
{
...
static bool ehl_vbt_ddi_d_present(struct xe_device *xe)
{
...
static bool phy_is_master(struct xe_device *dev_priv, enum phy phy)
{
	/*
...
static bool icl_combo_phy_verify_state(struct xe_device *dev_priv,
				       enum phy phy)
{
	bool ret = true;
	u32 expected_val = 0;
...
void intel_combo_phy_power_up_lanes(struct xe_device *dev_priv,
...
static void icl_combo_phys_init(struct xe_device *dev_priv)
{
	enum phy phy;
...
static void icl_combo_phys_uninit(struct xe_device *dev_priv)
{
	enum phy phy;
