...
struct intel_plane *
skl_universal_plane_create(struct xe_device *xe,
...
bool icl_is_nv12_y_plane(struct xe_device *xe,
			 enum plane_id plane_id);
u8 icl_hdr_plane_mask(void);
bool icl_is_hdr_plane(struct xe_device *xe, enum plane_id plane_id);
